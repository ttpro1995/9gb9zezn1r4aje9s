 ...
 */
public class AcceptFriendHandler extends BaseHandler {

	private static final Logger LOGGER = LogManager.getLogger(AcceptFriendHandler.class);

	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		MonitorStats.createThreadMonitorStats("AcceptFriendHandler");
		try {
			...
			if (!map.containsKey("uidTo")) {
				...
				try {
					...
					apiMessage = FriendModel.instance.acceptFriend(uid, uidTo);
