 ...
 */
public class GetListFriendHandler extends BaseHandler {

	private static final Logger LOGGER = LogManager.getLogger(GetListFriendHandler.class);

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		MonitorStats.createThreadMonitorStats("GetListFriendHandler");
		try {
			...
			apiMessage = FriendModel.instance.getlistFriend(uid, from, size);
