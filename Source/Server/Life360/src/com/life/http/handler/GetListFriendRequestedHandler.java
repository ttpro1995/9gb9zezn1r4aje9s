 ...
 */
public class GetListFriendRequestedHandler extends BaseHandler {

	private static final Logger LOGGER = LogManager.getLogger(GetListFriendRequestedHandler.class);

	@Override
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		MonitorStats.createThreadMonitorStats("GetListFriendRequestedHandler");
		try {
			...
			apiMessage = FriendModel.instance.getlistRequested(uid, from, size);
